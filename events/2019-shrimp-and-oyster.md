...
<p><a href="{{ '/assets/files/2019_Shrimp_Oyster_Feast_Flyer.pdf' | relative_url }}" target="_blank">Event Flyer</a></p>
...
<p align="center">
<table>
<tbody><tr><td><input type="hidden" name="on0" value="Ticket Delivery Options">Ticket Delivery Options</td></tr><tr>
<td align="center"><select name="os0" class="form-control">
	<option value="Pick up at door">Pick up at door </option>
	<option value="Mail to my paypal address">Mail to my paypal address </option>
</select> </td></tr>
</tbody></table>
</p><p>
